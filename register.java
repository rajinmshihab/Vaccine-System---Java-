...
public class register extends JFrame {
	...
	public register() {
		...
		JLabel lblNewLabel = new JLabel("Register for Covid-19 Vaccine");
		...
		panel.setBounds(20, 260, 430, 421);
		...
		lblNewLabel_1.setBounds(128, 11, 175, 35);
		...
		lblNewLabel_2_1.setBounds(263, 70, 83, 13);
		...
		lblNewLabel_2_2_1.setBounds(263, 133, 83, 13);
		...
		centerBox.setBounds(263, 157, 140, 26);
		panel.add(centerBox);
		
		// type drop down
		JLabel type = new JLabel("Type");
		type.setFont(new Font("Tahoma", Font.PLAIN, 15));
		type.setBounds(22, 209, 64, 21);
		panel.add(type);
		...
		typeBox.setBounds(76, 209, 120, 21);
		panel.add(typeBox);
		...
		comboBox.setBounds(76, 250, 45, 21);
		panel.add(comboBox);
		...
		lblNewLabel_2_2_2_1_1.setBounds(22, 330, 64, 21);
		...
		btnNewButton.setBounds(229, 390, 85, 21);
		...
		btnReset.setBounds(128, 390, 85, 21);
		...
		personNotFound.setBounds(404, 152, 165, 26);
		...
		login.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(isFound) {
					...
					scity.setText("Centre	:"+ Main.peoples.get(found_index).getCity());
